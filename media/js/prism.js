    ...
    Prism = function (u) {
        var c = /\blang(?:uage)?-([\w-]+)\b/i, n = 0, C = {
            ...
            highlightElement: function (e, n, r) {
                ...
                if (C.hooks.run("before-highlight", o), o.grammar) if (n && u.Worker) {
...
!function () {
    if ("undefined" != typeof self && self.Prism && self.document) if (Prism.plugins.toolbar) {
        ...
        if (!r) {
            ...
            }, o.src = "https://cdn.jsdelivr.net/npm/clipboard@2/dist/clipboard.min.js", e.appendChild(o)
        }
